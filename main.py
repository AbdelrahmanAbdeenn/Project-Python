...
if __name__ == "__main__":
    ...
    app.add_url_rule('/book/<int:id>', view_func=book_api, methods=['GET', 'PATCH', 'DELETE'])
    app.add_url_rule('/member', view_func=member_api, methods=['GET', 'POST'])
    app.add_url_rule('/member/<uuid:id>', view_func=member_api, methods=['GET', 'PATCH', 'DELETE'])
    app.add_url_rule('/borrow/<int:book_id>/<uuid:member_id>', view_func=borrow_api, methods=['POST'])
